...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.createUser = function (req, res) {
        service_1.default.create(req.body)
            ...
            .catch(_.partial(handlers_1.default.onError, res, 'Erro ao inserir novo usuarios'));
    };
    UserController.prototype.getById = function (req, res) {
        var userId = parseInt(req.params.id);
        service_1.default.getById(userId)
            .then(_.partial(handlers_1.default.onSuccess, res))
            .catch(_.partial(handlers_1.default.onError, res, 'Usuario nao encontrado'));
    };
    UserController.prototype.updateUser = function (req, res) {
        ...
        service_1.default.update(userId, props)
            .then(_.partial(handlers_1.default.onSuccess, res))
            .catch(_.partial(handlers_1.default.onError, res, 'Erro ao atualizar usuarios'));
    };
